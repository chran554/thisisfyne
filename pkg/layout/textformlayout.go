...
var _ fyne.Layout = (*textFormLayout)(nil)

// textFormLayout is two column grid where each row has a label and a widget.
type textFormLayout struct {
}

func (f *textFormLayout) countRows(objects []fyne.CanvasObject) int {
	count := 0
...
func (f *textFormLayout) tableCellsSize(objects []fyne.CanvasObject, containerWidth float32) [][2]fyne.Size {
...
func (f *textFormLayout) Layout(objects []fyne.CanvasObject, size fyne.Size) {
...
func (f *textFormLayout) MinSize(objects []fyne.CanvasObject) fyne.Size {
...
// NewTextFormLayout returns a new FormLayout instance
func NewTextFormLayout() fyne.Layout {
	return &textFormLayout{}
}
